...
// GET - Dashboard data (authenticated, admin/pastor for full stats)
export const GET = withAuth(async (
  ...
  try {
    ...
    // For non-admins, only return their own data
    if (!isAdminUser) {
      // Get user-specific data for regular members
      const [userRegistrations, userDonations, userPrayers] = await Promise.all([
