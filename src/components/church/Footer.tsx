...
import { Church, Heart, Mail, Phone, MapPin, Facebook, Instagram, Youtube, Twitter, Send, CheckCircle2, Loader2 } from 'lucide-react';
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex gap-4">
              ...
              {settings.socialTwitter && (
                <a href={settings.socialTwitter} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-amber-500 hover:text-white transition-colors">
                  <Twitter className="h-5 w-5" />
                </a>
              )}
              {!settings.socialFacebook && !settings.socialInstagram && !settings.socialYoutube && !settings.socialTwitter && (
                <>
