...
const allNavItems: NavItem[] = [
  ...
  { view: 'testimonies', label: 'Testimonies', icon: MessageSquare, feature: 'testimoniesEnabled' },
          ...
          >
            <div className="relative">
              {settings.logoUrl ? (
                ...
                <div className="relative">
                  <Church className="h-12 w-12 text-amber-500 group-hover:scale-110 transition-transform" />
                ...
                <div className="p-6 bg-gradient-to-br from-slate-900 to-slate-950 border-b border-slate-800">
                  <div className="flex items-center gap-3">
                    {settings.logoUrl ? (
                      ...
                      <div className="relative">
                        <Church className="h-14 w-14 text-amber-500" />
